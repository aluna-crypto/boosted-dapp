...
interface BaseControlProps extends Omit<PropsOf<typeof chakra.div>, "onChange" | "defaultChecked" | "checked"> {
}
export interface RadioProps extends UseRadioProps, ThemingProps, BaseControlProps {
    /**
