...
function useRadio(props) {
  ...
  return {
    ...
    getCheckboxProps: function getCheckboxProps(props, ref) {
      if (props === void 0) {
        props = {};
      }
    ...
    getInputProps: function getInputProps(props, _ref) {
      if (props === void 0) {
        props = {};
      }
    ...
    getLabelProps: function getLabelProps(props, ref) {
      ...
      return _extends({}, props, {
        ...
        onTouchStart: (0, _utils.callAllHandlers)(props.onTouchState, stop),
        "data-disabled": (0, _utils.dataAttr)(isDisabled),
        "data-checked": (0, _utils.dataAttr)(isChecked),
        "data-invalid": (0, _utils.dataAttr)(isInvalid)
      });
