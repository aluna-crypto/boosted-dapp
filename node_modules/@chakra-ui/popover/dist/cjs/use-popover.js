...
function usePopover(props) {
  ...
  var _props = props,
      ...
      _props$returnFocus = _props.returnFocus,
      ...
      trigger = _props$trigger === void 0 ? TRIGGER_TYPE.click : _props$trigger,
  ...
  (0, _popover.useFocusOnHide)(popoverRef, {
    autoFocus: returnFocus,
    visible: isOpen,
    focusRef: triggerRef,
    trigger: trigger
  });
  (0, _popover.useFocusOnShow)(popoverRef, {
    autoFocus: autoFocus,
    visible: isOpen,
