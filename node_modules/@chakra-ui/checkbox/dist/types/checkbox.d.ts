...
declare type BaseCheckboxProps = Pick<PropsOf<"input">, "onBlur" | "checked" | "defaultChecked">;
export interface CheckboxProps extends StyledControlProps, BaseCheckboxProps, ThemingProps, UseCheckboxProps {
    /**
