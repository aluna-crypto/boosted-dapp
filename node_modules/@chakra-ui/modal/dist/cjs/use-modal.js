...
function useModal(props) {
  ...
  var onOverlayClick = (0, _react.useCallback)(function (event) {
    ...
    if (_modalManager.manager.isTopModal(dialogRef)) {
  ...
  var getContentProps = (0, _react.useCallback)(function (props, ref) {
    if (props === void 0) {
      props = {};
    }
  ...
  var getOverlayProps = (0, _react.useCallback)(function (props, ref) {
    if (props === void 0) {
      props = {};
    }
