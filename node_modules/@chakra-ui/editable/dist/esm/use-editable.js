...
export function useEditable(props) {
  ...
  return {
    ...
    onCancel,
    onSubmit,
    getPreviewProps: function getPreviewProps(props, ref) {
      if (props === void 0) {
        props = {};
      }
    ...
    getEditButtonProps: function getEditButtonProps(props, ref) {
      if (props === void 0) {
        props = {};
      }
    ...
    getSubmitButtonProps: function getSubmitButtonProps(props, ref) {
      if (props === void 0) {
        props = {};
      }
    ...
    getCancelButtonProps: function getCancelButtonProps(props, ref) {
      if (props === void 0) {
        props = {};
      }
