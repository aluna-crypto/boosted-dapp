...
function useAccordion(props) {
  var onChange = props.onChange,
      ...
      htmlProps = _objectWithoutPropertiesLoose(props, ["onChange", "defaultIndex", "index", "allowMultiple", "allowToggle", "children"]); // validate the props and `warn` if used incorrectly
  ...
  var _children = validChildren.map(function (child, idx) {
    var isExpanded = (0, _utils.isArray)(index) ? index.includes(idx) : index === idx;
...
function useAccordionItem(props) {
  var isDisabled = props.isDisabled,
      ...
      isOpen = props.isOpen,
      id = props.id,
      htmlProps = _objectWithoutPropertiesLoose(props, ["isDisabled", "isFocusable", "onChange", "isOpen", "id"]);
