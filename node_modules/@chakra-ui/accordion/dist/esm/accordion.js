...
import { cx, createContext, runIfFn, __DEV__ } from "@chakra-ui/utils";
 ...
 */
export var Accordion = /*#__PURE__*/forwardRef(function Accordion(props, ref) {
  var styles = useMultiStyleConfig("Accordion", props);

  var _props = omitThemingProps(props);

  var _useAccordion = useAccordion(_props),
      {
    children,
    htmlProps
  } = _useAccordion,
  ...
  var _context = useMemo(() => _extends({}, context, {
...
export var AccordionItem = /*#__PURE__*/forwardRef(function AccordionItem(props, ref) {
  ...
  var _context = useMemo(() => context, [context]);
