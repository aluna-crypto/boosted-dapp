...
import { chakra, layoutPropNames, omitThemingProps, useMultiStyleConfig, forwardRef } from "@chakra-ui/system";
import { cx, split, __DEV__ } from "@chakra-ui/utils";
import * as React from "react";
export var SelectField = /*#__PURE__*/forwardRef(function SelectField(props, ref) {
  var {
    children,
    placeholder,
    className
  ...
  var select = useFormControl(rest);
  return /*#__PURE__*/React.createElement(chakra.select, _extends({}, select, {
    ref: ref,
    paddingRight: "2rem",
...
export var Select = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  var _omitThemingProps = omitThemingProps(props),
    ...
    color
      ...
      rest = _objectWithoutPropertiesLoose(_omitThemingProps, ["rootProps", "placeholder", "icon", "color"]);
