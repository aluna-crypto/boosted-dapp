...
import { callAllHandlers, focus, mergeRefs, normalizeEventKey, ariaAttr, minSafeInteger, maxSafeInteger, isBrowser } from "@chakra-ui/utils";
...
export function useNumberInput(props) {
  ...
  var getIncrementButtonProps = useCallback(function (props) {
    if (props === void 0) {
      props = {};
    }
  ...
  var getDecrementButtonProps = useCallback(function (props) {
    if (props === void 0) {
      props = {};
    }
  ...
  var getInputProps = useCallback(function (props) {
    if (props === void 0) {
      props = {};
    }
