...
var Stack = /*#__PURE__*/(0, _system.forwardRef)(function Stack(props, ref) {
  ...
  var isInline = props.isInline,
      ...
      direction = _props$direction === void 0 ? isInline ? "row" : "column" : _props$direction,
      align = props.align,
  ...
  }, _styles[selector] = (0, _utils.mapResponsive)(direction, function (value) {
    return directionStyles[value];
  }), _styles);
  var dividerStyles = (0, _utils.mapResponsive)(direction, function (value) {
  ...
  var sx = function sx(theme) {
    var _css;

    if (hasDivider) return undefined;
    return (0, _system.css)((_css = {}, _css[selector] = styles[selector], _css))(theme);
  };
