...
import { chakra, useMultiStyleConfig, omitThemingProps, StylesProvider, forwardRef } from "@chakra-ui/system";
...
export var InputGroup = /*#__PURE__*/forwardRef(function InputGroup(props, ref) {
  ...
  var clones = validChildren.map(child => {
    ...
    return child.type.id !== "Input" ? /*#__PURE__*/cloneElement(child, theming) : /*#__PURE__*/cloneElement(child, _extends({}, theming, {
