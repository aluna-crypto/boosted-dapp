...
export interface CircularProgressProps extends Omit<PropsOf<typeof chakra.div>, "color">, CircularProgressOptions {
}
/**
...
export interface CircularProgressLabelProps extends PropsOf<typeof CircularProgressLabel> {
}
export {};
