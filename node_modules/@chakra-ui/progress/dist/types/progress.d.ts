...
export interface ProgressFilledTrackProps extends PropsOf<typeof chakra.div>, GetProgressPropsOptions {
}
...
export interface ProgressProps extends ProgressOptions, ThemingProps, PropsOf<typeof chakra.div> {
}
/**
 * Progress (Linear)
 *
