...
export var Button = /*#__PURE__*/forwardRef(function Button(props, ref) {
  ...
  var _focus = merge({}, (_styles$_focus = styles == null ? void 0 : styles["_focus"]) != null ? _styles$_focus : {}, {
    zIndex: 1
  });
  ...
  return /*#__PURE__*/React.createElement(chakra.button, _extends({
    ...
    label: loadingText,
    children: spinner
  }), isLoading ? loadingText || /*#__PURE__*/React.createElement(chakra.span, {
    opacity: 0,
    children: children
...
var ButtonIcon = props => {
  ...
  var _children = /*#__PURE__*/isValidElement(children) ? /*#__PURE__*/cloneElement(children, {
    "aria-hidden": true,
    focusable: false
  }) : children;
