...
import { chakra, keyframes, useStyleConfig, forwardRef, omitThemingProps } from "@chakra-ui/system";
...
export var Skeleton = /*#__PURE__*/forwardRef(function Skeleton(props, ref) {
...
export var SkeletonText = props => {
  var {
    ...
    endColor
      ...
      rest = _objectWithoutPropertiesLoose(props, ["noOfLines", "spacing", "skeletonHeight", "className", "startColor", "endColor"]);
  ...
  return /*#__PURE__*/React.createElement(chakra.div, _extends({
    className: _className
  }, rest), numbers.map(number => /*#__PURE__*/React.createElement(Skeleton, {
    key: number,
